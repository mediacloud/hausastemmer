...
setup(
    ...
    long_description='''Hausa language stemmer reference implementation by Bimba et al., 2015.
...
Evaluation, 50(3), pp. 687–703. doi: 10.1007/s10579-015-9311-x. URL: https://bit.ly/hausa-stemming-bimba.
